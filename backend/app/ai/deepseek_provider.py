"""
NEXA AI — DeepSeek / Groq / OpenAI-Compatible Provider.
"""
...
class DeepSeekProvider(LLMProvider):
    """DeepSeek / Groq / OpenAI-Compatible LLM provider."""
    ...
    def _init_client(self):
        try:
            ...
            logger.info(f"DeepSeek/OpenAI-Compatible provider initialized: {self._model} @ {self._base_url}")
        except ImportError:
